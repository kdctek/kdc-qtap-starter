...
function kdc_qtap_ensure_fallback_menu( $dashboard_callback = null ) {
	...
	add_submenu_page(
		$menu_slug,
		__( 'qTap Dashboard', 'kdc-qtap-starter' ),
		__( 'Dashboard', 'kdc-qtap-starter' ),
		'manage_options',
		$menu_slug,
		$dashboard_callback ? $dashboard_callback : 'kdc_qtap_render_fallback_dashboard'
	);
...
function kdc_qtap_render_fallback_dashboard() {
	...
	?>
	<div class="wrap">
		<h1><?php echo esc_html__( 'qTap Dashboard', 'kdc-qtap-starter' ); ?></h1>

		<div class="notice notice-info" style="margin: 20px 0;">
			<p>
				<strong><?php echo esc_html__( 'qTap App Not Installed', 'kdc-qtap-starter' ); ?></strong><br>
				<?php
				printf(
					/* translators: %s: qTap App URL */
					esc_html__( 'Install the %s plugin for a full dashboard experience with all your qTap apps in one place.', 'kdc-qtap-starter' ),
		...
		<div class="card" style="max-width: 600px;">
			<h2><?php echo esc_html__( 'Your Active qTap Apps', 'kdc-qtap-starter' ); ?></h2>
			<p><?php echo esc_html__( 'Use the submenu items to access your installed qTap apps.', 'kdc-qtap-starter' ); ?></p>
		</div>
	</div>
	<?php
}
